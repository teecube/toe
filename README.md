...
This branch (*release-trigger-minor*) is a [**release trigger branch**](#release-trigger-branch) for the **T³ - TOE** project.
...
To trigger a new release with *minor* increment policy, simply [run a new pipeline](https://git.teecu.be/teecube/toe/pipelines/new) after selecting *release-trigger-minor* in the list.
That's it !
...
These versions numbers can also be [edited directly in Gitlab](https://git.teecu.be/teecube/toe/edit/release-trigger-minor/release.properties).
